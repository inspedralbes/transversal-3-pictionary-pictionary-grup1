    ...
    myCategories.forEach((category) => {
      if (category.categoryId === id) {
        ...
        let user = {
          ...
          privacy: category.privacy === "public" ? true : false,
        };
        ...
        .then((data) => {
          if (data.valid) {
            setCategoryListMessage(
              `Category ${data.category.name} added correctly`
            );
    ...
    if (editCat !== 0) {
      ...
      fetch(routes.fetchLaravel + "editCategory", {
        ...
        .then((data) => {
          if (data.valid) {
            setCategoryListMessage(
              `Category ${userData.name} updated correctly`
            );
            let user = { name: "", privacy: false };
            setUserData(user);
            setWordList([{ word: "" }]);
      ...
      {!addCategory ? (
                    ...
                    <table className="myCategories__table">
                      ...
                      <tfoot>
                        <tr className="myCategories__tfoot">
                          ...
                          <td className="myCategories__td"></td>
                          <td className="myCategories__td"></td>
                          <td className="myCategories__addCategoryButton">
                            <button
                              id="add"
                              onMouseOver={changeColor}
                              onClick={handleSetAddCategory}
                            >
                              <i className="icon-plus"></i>Add category
                            </button>
                          </td>
                        </tr>
                      </tfoot>
        ...
        <div className="addCategory">
          ...
          <fieldset>
            ...
            <br />
            {addCategoryMessage !== "" && (
              <h3 style={{ textAlign: "center" }}>{addCategoryMessage}</h3>
            )}
            <div className="addCategory__form">
              <div className="addCategory__nameTA">
                <span className="addCategory__formSpanTA">
                  <p className="addCategory__Name">CATEGORY NAME</p>
                  <input
                    className="input"
                    id="name"
                    type="text"
                    placeholder={userData.name === '' ? "Introduce  category name" : userData.name}
                    onChange={(e) =>
                  ...
                  <div key={index} className="words">
                    <div className="wordSettings">
                      ...
                      <div className="addCategory__form">
                        <div className="addCategory__nameTA">
                          <span className="addCategory__formSpanTA">
                            <p className="addCategory__description">
                              Description
                            </p>
                            <textarea
                              className="text-area"
                ...
                <label className="addCategory__public">
                  <div className="list__container__text">
                    ...
                    >
                      ...
                      <span style={{ marginLeft: "-326px", marginTop: "10px" }}>
                        Do you want the category to be public?
                      </span>
                    </label>
                  </div>
                </label>
